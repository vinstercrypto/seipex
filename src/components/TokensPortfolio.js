...
const TokensPortfolio = ({ wallet, data, calledTokens, soldTokens, handleSellAgain, logAndUpdateConsole, openConfirmModal }) => {
    return (
                        ...
                        <>
                            ...
                            {soldTokens.map((token, index) => (
                                <div key={index} className="calledTokenBox">
                                    ...
                                    {calledTokens.some(ct => ct.address === token.address) && (
                                        <div className="calledTokenField">
                    ...
                    data.map((result, index) => (
                        <div key={index} className="tokenBox">
                            ...
                            <div className="tokenField">
                                ...
                                <button className="copyButton" onClick={() => openConfirmModal(result)}>Jeet 100%</button>
                            </div>
                        </div>
                    ))
                )}
